...
@interface PDDatabaseHelper_1 : NSObject < JavaUtilConcurrentCallable > {
 @public
  PDDatabaseHelper *this$0_;
  PDParty *val$party_;
}

- (instancetype)initWithPDDatabaseHelper:(PDDatabaseHelper *)outer$
                             withPDParty:(PDParty *)capture$0;

- (JavaLangVoid *)call;

@end

J2OBJC_EMPTY_STATIC_INIT(PDDatabaseHelper_1)

__attribute__((unused)) static void PDDatabaseHelper_1_initWithPDDatabaseHelper_withPDParty_(PDDatabaseHelper_1 *self, PDDatabaseHelper *outer$, PDParty *capture$0);

__attribute__((unused)) static PDDatabaseHelper_1 *new_PDDatabaseHelper_1_initWithPDDatabaseHelper_withPDParty_(PDDatabaseHelper *outer$, PDParty *capture$0) NS_RETURNS_RETAINED;

__attribute__((unused)) static PDDatabaseHelper_1 *create_PDDatabaseHelper_1_initWithPDDatabaseHelper_withPDParty_(PDDatabaseHelper *outer$, PDParty *capture$0);
...
- (void)deletePartyWithPDParty:(PDParty *)party {
  [self performTransactionOrThrowRuntimeWithJavaUtilConcurrentCallable:create_PDDatabaseHelper_1_initWithPDDatabaseHelper_withPDParty_(self, party)];
}
...
@implementation PDDatabaseHelper_1

- (instancetype)initWithPDDatabaseHelper:(PDDatabaseHelper *)outer$
                             withPDParty:(PDParty *)capture$0 {
  PDDatabaseHelper_1_initWithPDDatabaseHelper_withPDParty_(self, outer$, capture$0);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  #pragma clang diagnostic push
  #pragma clang diagnostic ignored "-Wobjc-multiple-method-names"
  methods[0].selector = @selector(initWithPDDatabaseHelper:withPDParty:);
  methods[1].selector = @selector(call);
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    { "this$0_", "LPDDatabaseHelper;", .constantValue.asLong = 0, 0x1012, -1, -1, -1, -1 },
    { "val$party_", "LPDParty;", .constantValue.asLong = 0, 0x1012, -1, -1, -1, -1 },
  };
  static const void *ptrTable[] = { "LJavaLangException;", "LPDDatabaseHelper;", "deletePartyWithPDParty:", "Ljava/lang/Object;Ljava/util/concurrent/Callable<Ljava/lang/Void;>;" };
  static const J2ObjcClassInfo _PDDatabaseHelper_1 = { "", "com.kgalligan.partyclicker.data", ptrTable, methods, fields, 7, 0x8018, 2, 2, 1, -1, 2, 3, -1 };
  return &_PDDatabaseHelper_1;
}

@end

void PDDatabaseHelper_1_initWithPDDatabaseHelper_withPDParty_(PDDatabaseHelper_1 *self, PDDatabaseHelper *outer$, PDParty *capture$0) {
  JreStrongAssign(&self->this$0_, outer$);
  JreStrongAssign(&self->val$party_, capture$0);
  NSObject_init(self);
}

PDDatabaseHelper_1 *new_PDDatabaseHelper_1_initWithPDDatabaseHelper_withPDParty_(PDDatabaseHelper *outer$, PDParty *capture$0) {
  J2OBJC_NEW_IMPL(PDDatabaseHelper_1, initWithPDDatabaseHelper_withPDParty_, outer$, capture$0)
}

PDDatabaseHelper_1 *create_PDDatabaseHelper_1_initWithPDDatabaseHelper_withPDParty_(PDDatabaseHelper *outer$, PDParty *capture$0) {
  J2OBJC_CREATE_IMPL(PDDatabaseHelper_1, initWithPDDatabaseHelper_withPDParty_, outer$, capture$0)
}
