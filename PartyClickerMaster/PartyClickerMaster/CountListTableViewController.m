//
//  CountListTableViewController.m
//  PartyClickerMaster
//
...
@interface CountListTableViewController ()

@property (nonatomic, strong) JavaUtilArrayList *people;

@end

@implementation CountListTableViewController
