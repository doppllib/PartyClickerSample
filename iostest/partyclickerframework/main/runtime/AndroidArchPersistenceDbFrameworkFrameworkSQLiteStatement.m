...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LAndroidDatabaseSqliteSQLiteStatement;", "bindNull", "I", "bindLong", "IJ", "bindDouble", "ID", "bindString", "ILNSString;", "bindBlob", "I[B" };
  static const J2ObjcClassInfo _AndroidArchPersistenceDbFrameworkFrameworkSQLiteStatement = { "FrameworkSQLiteStatement", "android.arch.persistence.db.framework", ptrTable, methods, fields, 7, 0x1, 12, 1, -1, -1, -1, -1, -1 };
