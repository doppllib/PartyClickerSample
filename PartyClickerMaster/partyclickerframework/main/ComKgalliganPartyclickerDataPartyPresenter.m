...
- (void)init__ {
  JreStrongAssign(&party_, [((ComKgalliganPartyclickerDataDatabaseHelper *) nil_chk(databaseHelper_)) loadPartyWithInt:partyId_]);
  partyCount_ = [((ComKgalliganPartyclickerDataDatabaseHelper *) nil_chk(databaseHelper_)) countCurrentPartyWithInt:partyId_];
}

- (void)addPerson {
  partyCount_++;
  [((id<JavaUtilConcurrentExecutorService>) nil_chk(executorService_)) executeWithJavaLangRunnable:create_ComKgalliganPartyclickerDataModPersonTask_initWithComKgalliganPartyclickerDataParty_withBoolean_withComKgalliganPartyclickerDataDatabaseHelper_(party_, true, databaseHelper_)];
}

- (void)removePerson {
  if (partyCount_ > 0) {
    partyCount_--;
    [((id<JavaUtilConcurrentExecutorService>) nil_chk(executorService_)) executeWithJavaLangRunnable:create_ComKgalliganPartyclickerDataModPersonTask_initWithComKgalliganPartyclickerDataParty_withBoolean_withComKgalliganPartyclickerDataDatabaseHelper_(party_, false, databaseHelper_)];
  }
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "databaseHelper_", "LComKgalliganPartyclickerDataDatabaseHelper;", .constantValue.asLong = 0, 0x0, -1, -1, -1, 2 },
  };
