...
- (void)addObserverWithAndroidArchPersistenceRoomInvalidationTracker_Observer:(AndroidArchPersistenceRoomInvalidationTracker_Observer *)observer {
  ...
  AndroidArchPersistenceRoomInvalidationTracker_ObserverWrapper *wrapper = create_AndroidArchPersistenceRoomInvalidationTracker_ObserverWrapper_initWithAndroidArchPersistenceRoomInvalidationTracker_Observer_withIntArray_withLongArray_(observer, tableIds, versions);
  AndroidArchPersistenceRoomInvalidationTracker_ObserverWrapper *currentObserver;
  @synchronized(mObserverMap_) {
    currentObserver = [((AndroidArchCoreInternalSafeIterableMap *) nil_chk(mObserverMap_)) putIfAbsentWithId:observer withId:wrapper];
  }
  if (currentObserver == nil && [((AndroidArchPersistenceRoomInvalidationTracker_ObservedTableTracker *) nil_chk(mObservedTableTracker_)) onAddedWithIntArray:tableIds]) {
    [((AndroidArchCoreExecutorAppToolkitTaskExecutor *) nil_chk(AndroidArchCoreExecutorAppToolkitTaskExecutor_getInstance())) executeOnDiskIOWithJavaLangRunnable:mSyncTriggers_];
  }
}
...
- (void)removeObserverWithAndroidArchPersistenceRoomInvalidationTracker_Observer:(AndroidArchPersistenceRoomInvalidationTracker_Observer *)observer {
  AndroidArchPersistenceRoomInvalidationTracker_ObserverWrapper *wrapper;
  @synchronized(mObserverMap_) {
    wrapper = [((AndroidArchCoreInternalSafeIterableMap *) nil_chk(mObserverMap_)) removeWithId:observer];
  }
...
- (void)refreshVersionsAsync {
  if ([((JavaUtilConcurrentAtomicAtomicBoolean *) nil_chk(mPendingRefresh_)) compareAndSetWithBoolean:false withBoolean:true]) {
    [((AndroidArchCoreExecutorAppToolkitTaskExecutor *) nil_chk(AndroidArchCoreExecutorAppToolkitTaskExecutor_getInstance())) executeOnDiskIOWithJavaLangRunnable:mRefreshRunnable_];
  }
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[10].selector = @selector(syncTriggers);
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "mQueryArgs_", "[LNSString;", .constantValue.asLong = 0, 0x2, -1, -1, -1, -1 },
  ...
  static const J2ObjcClassInfo _AndroidArchPersistenceRoomInvalidationTracker = { "InvalidationTracker", "android.arch.persistence.room", ptrTable, methods, fields, 7, 0x1, 11, 20, -1, 21, -1, -1, -1 };
...
void AndroidArchPersistenceRoomInvalidationTracker_initWithAndroidArchPersistenceRoomRoomDatabase_withNSStringArray_(AndroidArchPersistenceRoomInvalidationTracker *self, AndroidArchPersistenceRoomRoomDatabase *database, IOSObjectArray *tableNames) {
  NSObject_init(self);
  JreStrongAssignAndConsume(&self->mQueryArgs_, [IOSObjectArray newArrayWithLength:1 type:NSString_class_()]);
  self->mMaxVersion_ = -1;
...
void AndroidArchPersistenceRoomInvalidationTracker_appendTriggerNameWithJavaLangStringBuilder_withNSString_withNSString_(JavaLangStringBuilder *builder, NSString *tableName, NSString *triggerType) {
  ...
  [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk(builder)) appendWithNSString:@"room_table_modification_trigger_"])) appendWithNSString:tableName])) appendWithNSString:@"_"])) appendWithNSString:triggerType];
}
...
- (void)run {
  ...
  @catch (JavaLangIllegalStateException *exception) {
    AndroidUtilLog_eWithNSString_withNSString_withNSException_(AndroidArchPersistenceRoomRoom_LOG_TAG, @"Cannot run invalidation tracker. Is the db closed?", exception);
  }
...
- (void)run {
  ...
  if ([((AndroidArchPersistenceRoomRoomDatabase *) nil_chk(this$0_->mDatabase_)) inTransaction] || ![((JavaUtilConcurrentAtomicAtomicBoolean *) nil_chk(this$0_->mPendingRefresh_)) compareAndSetWithBoolean:true withBoolean:false]) {
    return;
  }
  ...
  @try {
    ...
    IOSObjectArray_Set(nil_chk(this$0_->mQueryArgs_), 0, JavaLangLong_toStringWithLong_(this$0_->mMaxVersion_));
    id<AndroidDatabaseCursor> cursor = [this$0_->mDatabase_ queryWithNSString:AndroidArchPersistenceRoomInvalidationTracker_SELECT_UPDATED_TABLES_SQL withNSStringArray:this$0_->mQueryArgs_];
    @try {
...
- (instancetype)initWithAndroidArchPersistenceRoomInvalidationTracker_Observer:(AndroidArchPersistenceRoomInvalidationTracker_Observer *)observer
  ...
  AndroidArchPersistenceRoomInvalidationTracker_ObserverWrapper_initWithAndroidArchPersistenceRoomInvalidationTracker_Observer_withIntArray_withLongArray_(self, observer, tableIds, versions);
  return self;
}
...
- (void)checkForInvalidationWithLongArray:(IOSLongArray *)versions {
  ...
  if (invalid) {
    [((AndroidArchPersistenceRoomInvalidationTracker_Observer *) nil_chk(mObserver_)) onInvalidated];
  }
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  #pragma clang diagnostic push
  #pragma clang diagnostic ignored "-Wobjc-multiple-method-names"
  methods[0].selector = @selector(initWithAndroidArchPersistenceRoomInvalidationTracker_Observer:withIntArray:withLongArray:);
  ...
  static const void *ptrTable[] = { "LAndroidArchPersistenceRoomInvalidationTracker_Observer;[I[J", "checkForInvalidation", "[J", "LAndroidArchPersistenceRoomInvalidationTracker;" };
  static const J2ObjcClassInfo _AndroidArchPersistenceRoomInvalidationTracker_ObserverWrapper = { "ObserverWrapper", "android.arch.persistence.room", ptrTable, methods, fields, 7, 0x8, 2, 3, 3, -1, -1, -1, -1 };
  return &_AndroidArchPersistenceRoomInvalidationTracker_ObserverWrapper;
}

@end

void AndroidArchPersistenceRoomInvalidationTracker_ObserverWrapper_initWithAndroidArchPersistenceRoomInvalidationTracker_Observer_withIntArray_withLongArray_(AndroidArchPersistenceRoomInvalidationTracker_ObserverWrapper *self, AndroidArchPersistenceRoomInvalidationTracker_Observer *observer, IOSIntArray *tableIds, IOSLongArray *versions) {
  NSObject_init(self);
...
AndroidArchPersistenceRoomInvalidationTracker_ObserverWrapper *new_AndroidArchPersistenceRoomInvalidationTracker_ObserverWrapper_initWithAndroidArchPersistenceRoomInvalidationTracker_Observer_withIntArray_withLongArray_(AndroidArchPersistenceRoomInvalidationTracker_Observer *observer, IOSIntArray *tableIds, IOSLongArray *versions) {
  J2OBJC_NEW_IMPL(AndroidArchPersistenceRoomInvalidationTracker_ObserverWrapper, initWithAndroidArchPersistenceRoomInvalidationTracker_Observer_withIntArray_withLongArray_, observer, tableIds, versions)
}

AndroidArchPersistenceRoomInvalidationTracker_ObserverWrapper *create_AndroidArchPersistenceRoomInvalidationTracker_ObserverWrapper_initWithAndroidArchPersistenceRoomInvalidationTracker_Observer_withIntArray_withLongArray_(AndroidArchPersistenceRoomInvalidationTracker_Observer *observer, IOSIntArray *tableIds, IOSLongArray *versions) {
  J2OBJC_CREATE_IMPL(AndroidArchPersistenceRoomInvalidationTracker_ObserverWrapper, initWithAndroidArchPersistenceRoomInvalidationTracker_Observer_withIntArray_withLongArray_, observer, tableIds, versions)
}
...
- (instancetype)initWithNSString:(NSString *)firstTable
...
- (instancetype)initWithNSStringArray:(IOSObjectArray *)tables {
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LNSString;[LNSString;", "[LNSString;", "LAndroidArchPersistenceRoomInvalidationTracker;" };
  static const J2ObjcClassInfo _AndroidArchPersistenceRoomInvalidationTracker_Observer = { "Observer", "android.arch.persistence.room", ptrTable, methods, fields, 7, 0x409, 3, 1, 2, -1, -1, -1, -1 };
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "mDelegateRef_", "LJavaLangRefWeakReference;", .constantValue.asLong = 0, 0x10, -1, -1, 1, -1 },
  };
  static const void *ptrTable[] = { "LAndroidArchPersistenceRoomInvalidationTracker;LAndroidArchPersistenceRoomInvalidationTracker_Observer;", "Ljava/lang/ref/WeakReference<Landroid/arch/persistence/room/InvalidationTracker$Observer;>;", "LAndroidArchPersistenceRoomInvalidationTracker;" };
  static const J2ObjcClassInfo _AndroidArchPersistenceRoomInvalidationTracker_WeakObserver = { "WeakObserver", "android.arch.persistence.room", ptrTable, methods, fields, 7, 0x8, 2, 2, 2, -1, -1, -1, -1 };
