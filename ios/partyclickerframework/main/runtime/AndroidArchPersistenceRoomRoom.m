...
+ (AndroidArchPersistenceRoomRoomDatabase_Builder *)databaseBuilderWithAndroidContentContext:(AndroidContentContext *)context
...
+ (AndroidArchPersistenceRoomRoomDatabase_Builder *)inMemoryDatabaseBuilderWithAndroidContentContext:(AndroidContentContext *)context
                                                                                        withIOSClass:(IOSClass *)klass {
  return AndroidArchPersistenceRoomRoom_inMemoryDatabaseBuilderWithAndroidContentContext_withIOSClass_(context, klass);
}

+ (id)getGeneratedImplementationWithIOSClass:(IOSClass *)klass
...
AndroidArchPersistenceRoomRoomDatabase_Builder *AndroidArchPersistenceRoomRoom_databaseBuilderWithAndroidContentContext_withIOSClass_withNSString_(AndroidContentContext *context, IOSClass *klass, NSString *name) {
  ...
  if (name == nil || [((NSString *) nil_chk([name java_trim])) java_length] == 0) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"Cannot create a database with null or empty name. If you are trying to create an in memory database, use Room.inMemoryDatabaseBuilder");
  }
