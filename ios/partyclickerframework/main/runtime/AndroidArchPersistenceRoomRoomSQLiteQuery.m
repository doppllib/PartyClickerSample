...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[6].selector = @selector(bindToWithAndroidArchPersistenceDbSupportSQLiteProgram:);
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "sQueryPool", "LJavaUtilTreeMap;", .constantValue.asLong = 0, 0x18, -1, 16, 17, -1 },
  ...
  static const void *ptrTable[] = { "acquire", "LNSString;I", "I", "init", "release", "bindTo", "LAndroidArchPersistenceDbSupportSQLiteProgram;", "bindNull", "bindLong", "IJ", "bindDouble", "ID", "bindString", "ILNSString;", "bindBlob", "I[B", &AndroidArchPersistenceRoomRoomSQLiteQuery_sQueryPool, "Ljava/util/TreeMap<Ljava/lang/Integer;Landroid/arch/persistence/room/RoomSQLiteQuery;>;", "LAndroidArchPersistenceRoomRoomSQLiteQuery_Binding;" };
  static const J2ObjcClassInfo _AndroidArchPersistenceRoomRoomSQLiteQuery = { "RoomSQLiteQuery", "android.arch.persistence.room", ptrTable, methods, fields, 7, 0x1, 13, 16, -1, 18, -1, -1, -1 };
