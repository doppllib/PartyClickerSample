...
- (void)init__WithAndroidArchPersistenceRoomDatabaseConfiguration:(AndroidArchPersistenceRoomDatabaseConfiguration *)configuration {
  ...
  mAllowMainThreadQueries_ = ((AndroidArchPersistenceRoomDatabaseConfiguration *) nil_chk(configuration))->allowMainThreadQueries_;
}
...
- (jboolean)isOpen {
  __unused id<AndroidArchPersistenceDbSupportSQLiteDatabase> db = JreLoadVolatileId(&mDatabase_);
...
- (void)assertNotMainThread {
  ...
  if ([((AndroidArchCoreExecutorAppToolkitTaskExecutor *) nil_chk(AndroidArchCoreExecutorAppToolkitTaskExecutor_getInstance())) isMainThread]) {
    @throw create_JavaLangIllegalStateException_initWithNSString_(@"Cannot access database on the main thread since it may potentially lock the UI for a long periods of time.");
  }
}
...
- (id<AndroidDatabaseCursor>)queryWithNSString:(NSString *)sql
  ...
  return [((id<AndroidArchPersistenceDbSupportSQLiteDatabase>) nil_chk([((id<AndroidArchPersistenceDbSupportSQLiteOpenHelper>) nil_chk(mOpenHelper_)) getWritableDatabase])) rawQueryWithNSString:sql withNSStringArray:selectionArgs];
}
...
- (id<AndroidDatabaseCursor>)queryWithAndroidArchPersistenceDbSupportSQLiteQuery:(id<AndroidArchPersistenceDbSupportSQLiteQuery>)query {
  [self assertNotMainThread];
  return [((id<AndroidArchPersistenceDbSupportSQLiteDatabase>) nil_chk([((id<AndroidArchPersistenceDbSupportSQLiteOpenHelper>) nil_chk(mOpenHelper_)) getWritableDatabase])) rawQueryWithAndroidArchPersistenceDbSupportSQLiteQuery:query];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[1].selector = @selector(init__WithAndroidArchPersistenceRoomDatabaseConfiguration:);
  methods[2].selector = @selector(getOpenHelper);
  methods[3].selector = @selector(createOpenHelperWithAndroidArchPersistenceRoomDatabaseConfiguration:);
  methods[4].selector = @selector(createInvalidationTracker);
  methods[5].selector = @selector(isOpen);
  methods[6].selector = @selector(close);
  methods[7].selector = @selector(assertNotMainThread);
  methods[8].selector = @selector(queryWithNSString:withNSStringArray:);
  methods[9].selector = @selector(queryWithAndroidArchPersistenceDbSupportSQLiteQuery:);
  methods[10].selector = @selector(compileStatementWithNSString:);
  methods[11].selector = @selector(beginTransaction);
  methods[12].selector = @selector(endTransaction);
  methods[13].selector = @selector(setTransactionSuccessful);
  methods[14].selector = @selector(internalInitInvalidationTrackerWithAndroidArchPersistenceDbSupportSQLiteDatabase:);
  methods[15].selector = @selector(getInvalidationTracker);
  methods[16].selector = @selector(inTransaction);
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    { "DB_IMPL_SUFFIX", "LNSString;", .constantValue.asLong = 0, 0x1a, -1, 10, -1, -1 },
  ...
  static const void *ptrTable[] = { "init", "LAndroidArchPersistenceRoomDatabaseConfiguration;", "createOpenHelper", "query", "LNSString;[LNSString;", "LAndroidArchPersistenceDbSupportSQLiteQuery;", "compileStatement", "LNSString;", "internalInitInvalidationTracker", "LAndroidArchPersistenceDbSupportSQLiteDatabase;", &AndroidArchPersistenceRoomRoomDatabase_DB_IMPL_SUFFIX, "LAndroidArchPersistenceRoomRoomDatabase_Builder;LAndroidArchPersistenceRoomRoomDatabase_MigrationContainer;" };
  static const J2ObjcClassInfo _AndroidArchPersistenceRoomRoomDatabase = { "RoomDatabase", "android.arch.persistence.room", ptrTable, methods, fields, 7, 0x401, 17, 5, -1, 11, -1, -1, -1 };
...
- (AndroidArchPersistenceRoomRoomDatabase *)build {
  ...
  __unused AndroidArchPersistenceRoomDatabaseConfiguration *configuration = create_AndroidArchPersistenceRoomDatabaseConfiguration_initWithAndroidContentContext_withNSString_withAndroidArchPersistenceDbSupportSQLiteOpenHelper_Factory_withAndroidArchPersistenceRoomRoomDatabase_MigrationContainer_withBoolean_(mContext_, mName_, mFactory_, mMigrationContainer_, mAllowMainThreadQueries_);
  __unused AndroidArchPersistenceRoomRoomDatabase *db = AndroidArchPersistenceRoomRoom_getGeneratedImplementationWithIOSClass_withNSString_(mDatabaseClass_, AndroidArchPersistenceRoomRoomDatabase_DB_IMPL_SUFFIX);
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LAndroidArchPersistenceRoomRoomDatabase;", 0x1, -1, -1, -1, 9, -1, -1 },
  };
  #pragma clang diagnostic push
  #pragma clang diagnostic ignored "-Wobjc-multiple-method-names"
  ...
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    { "mDatabaseClass_", "LIOSClass;", .constantValue.asLong = 0, 0x12, -1, -1, 10, -1 },
...
- (void)addMigrationsWithAndroidArchPersistenceRoomMigrationMigrationArray:(IOSObjectArray *)migrations {
  {
    ...
    while (b__ < e__) {
      __unused AndroidArchPersistenceRoomMigrationMigration *migration = *b__++;
...
- (id<JavaUtilList>)findMigrationPathWithInt:(jint)start
  ...
  __unused jboolean migrateUp = end > start;
...
void AndroidArchPersistenceRoomRoomDatabase_MigrationContainer_addMigrationWithAndroidArchPersistenceRoomMigrationMigration_(AndroidArchPersistenceRoomRoomDatabase_MigrationContainer *self, AndroidArchPersistenceRoomMigrationMigration *migration) {
  __unused jint start = ((AndroidArchPersistenceRoomMigrationMigration *) nil_chk(migration))->startVersion_;
  __unused jint end = migration->endVersion_;
  __unused AndroidUtilSparseArray *targetMap = [((AndroidUtilSparseArray *) nil_chk(self->mMigrations_)) getWithInt:start];
  if (targetMap == nil) {
  ...
  __unused AndroidArchPersistenceRoomMigrationMigration *existing = [targetMap getWithInt:end];
  if (existing != nil) {
...
id<JavaUtilList> AndroidArchPersistenceRoomRoomDatabase_MigrationContainer_findUpMigrationPathWithJavaUtilList_withBoolean_withInt_withInt_(AndroidArchPersistenceRoomRoomDatabase_MigrationContainer *self, id<JavaUtilList> result, jboolean upgrade, jint start, jint end) {
  __unused jint searchDirection = upgrade ? -1 : 1;
  while (upgrade ? start < end : start > end) {
    __unused AndroidUtilSparseArray *targetNodes = [((AndroidUtilSparseArray *) nil_chk(self->mMigrations_)) getWithInt:start];
    if (targetNodes == nil) {
      return nil;
    }
    __unused jint size = [targetNodes size];
    __unused jint firstIndex;
    __unused jint lastIndex;
    if (upgrade) {
      firstIndex = size - 1;
      lastIndex = -1;
    }
    ...
    __unused jboolean found = false;
    for (jint i = firstIndex; i != lastIndex; i += searchDirection) {
      __unused jint targetVersion = [targetNodes keyAtWithInt:i];
