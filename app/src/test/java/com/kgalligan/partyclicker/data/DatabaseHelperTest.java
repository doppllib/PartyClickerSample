...
public class DatabaseHelperTest
{
    ...
    public void countCurrentParty() throws Exception
    {
        ...
        int actual = databaseHelper.countCurrentParty(party.getId());
    ...
    public void allPeopleForParty() throws Exception
    {
        ...
        List<Person> people = databaseHelper.allPeopleForParty(party).blockingFirst();
    ...
    public void addPerson() throws Exception
    {
        ...
        assertEquals(5, databaseHelper.allPeopleForParty(party).blockingFirst().size());
        assertEquals(3, databaseHelper.countCurrentParty(party.getId()));
    }
    ...
    {
        assertEquals(1, databaseHelper.allParties().blockingFirst().size());
        databaseHelper.createParty("asdf");
        databaseHelper.createParty("qwert");
        assertEquals(3, databaseHelper.allParties().blockingFirst().size());
    }
    ...
    {
        databaseHelper.createParty("asdf");
        List<Party> parties = databaseHelper.allParties().blockingFirst();
    ...
    public void deleteParty() throws Exception
    {
        ...
        List<Party> laterParties = databaseHelper.allParties().blockingFirst();
