...
- (void)insertWithJavaUtilCollection:(id<JavaUtilCollection>)entities {
  __unused id<AndroidArchPersistenceDbSupportSQLiteStatement> stmt = [self acquire];
  @try {
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "[J", 0x11, 13, 9, -1, 14, -1, -1 },
    { NULL, "[J", 0x11, 13, 7, -1, 15, -1, -1 },
    { NULL, "LJavaUtilList;", 0x11, 16, 7, -1, 17, -1, -1 },
    { NULL, "LJavaUtilList;", 0x11, 16, 9, -1, 18, -1, -1 },
  };
  ...
  methods[4].selector = @selector(insertWithJavaUtilCollection:);
  ...
  methods[8].selector = @selector(insertAndReturnIdsListWithNSObjectArray:);
  methods[9].selector = @selector(insertAndReturnIdsListWithJavaUtilCollection:);
  #pragma clang diagnostic pop
  static const void *ptrTable[] = { "LAndroidArchPersistenceRoomRoomDatabase;", "bind", "LAndroidArchPersistenceDbSupportSQLiteStatement;LNSObject;", "(Landroid/arch/persistence/db/SupportSQLiteStatement;TT;)V", "insert", "LNSObject;", "(TT;)V", "[LNSObject;", "([TT;)V", "LJavaUtilCollection;", "(Ljava/util/Collection<TT;>;)V", "insertAndReturnId", "(TT;)J", "insertAndReturnIdsArray", "(Ljava/util/Collection<TT;>;)[J", "([TT;)[J", "insertAndReturnIdsList", "([TT;)Ljava/util/List<Ljava/lang/Long;>;", "(Ljava/util/Collection<TT;>;)Ljava/util/List<Ljava/lang/Long;>;", "<T:Ljava/lang/Object;>Landroid/arch/persistence/room/SharedSQLiteStatement;" };
  static const J2ObjcClassInfo _AndroidArchPersistenceRoomEntityInsertionAdapter = { "EntityInsertionAdapter", "android.arch.persistence.room", ptrTable, methods, NULL, 7, 0x401, 10, 0, -1, -1, -1, 19, -1 };
