...
- (jint)handleMultipleWithJavaUtilCollection:(id<JavaUtilCollection>)entities {
  __unused id<AndroidArchPersistenceDbSupportSQLiteStatement> stmt = [self acquire];
  @try {
