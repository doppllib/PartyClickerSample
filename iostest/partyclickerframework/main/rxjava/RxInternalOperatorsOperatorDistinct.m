...
__attribute__((unused)) static void RxInternalOperatorsOperatorDistinct_1_initWithRxInternalOperatorsOperatorDistinct_withRxSubscriber_withRxSubscriber_(RxInternalOperatorsOperatorDistinct_1 *self, RxInternalOperatorsOperatorDistinct *outer$, RxSubscriber *capture$0, RxSubscriber *subscriber);

__attribute__((unused)) static RxInternalOperatorsOperatorDistinct_1 *new_RxInternalOperatorsOperatorDistinct_1_initWithRxInternalOperatorsOperatorDistinct_withRxSubscriber_withRxSubscriber_(RxInternalOperatorsOperatorDistinct *outer$, RxSubscriber *capture$0, RxSubscriber *subscriber) NS_RETURNS_RETAINED;

__attribute__((unused)) static RxInternalOperatorsOperatorDistinct_1 *create_RxInternalOperatorsOperatorDistinct_1_initWithRxInternalOperatorsOperatorDistinct_withRxSubscriber_withRxSubscriber_(RxInternalOperatorsOperatorDistinct *outer$, RxSubscriber *capture$0, RxSubscriber *subscriber);
...
- (instancetype)initWithRxInternalOperatorsOperatorDistinct:(RxInternalOperatorsOperatorDistinct *)outer$
                                           withRxSubscriber:(RxSubscriber *)capture$0
                                           withRxSubscriber:(RxSubscriber *)subscriber {
  RxInternalOperatorsOperatorDistinct_1_initWithRxInternalOperatorsOperatorDistinct_withRxSubscriber_withRxSubscriber_(self, outer$, capture$0, subscriber);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _RxInternalOperatorsOperatorDistinct_1 = { "", "rx.internal.operators", ptrTable, methods, fields, 7, 0x8018, 4, 3, 10, -1, 11, 12, -1 };
  return &_RxInternalOperatorsOperatorDistinct_1;
}

@end

void RxInternalOperatorsOperatorDistinct_1_initWithRxInternalOperatorsOperatorDistinct_withRxSubscriber_withRxSubscriber_(RxInternalOperatorsOperatorDistinct_1 *self, RxInternalOperatorsOperatorDistinct *outer$, RxSubscriber *capture$0, RxSubscriber *subscriber) {
...
RxInternalOperatorsOperatorDistinct_1 *new_RxInternalOperatorsOperatorDistinct_1_initWithRxInternalOperatorsOperatorDistinct_withRxSubscriber_withRxSubscriber_(RxInternalOperatorsOperatorDistinct *outer$, RxSubscriber *capture$0, RxSubscriber *subscriber) {
  J2OBJC_NEW_IMPL(RxInternalOperatorsOperatorDistinct_1, initWithRxInternalOperatorsOperatorDistinct_withRxSubscriber_withRxSubscriber_, outer$, capture$0, subscriber)
}

RxInternalOperatorsOperatorDistinct_1 *create_RxInternalOperatorsOperatorDistinct_1_initWithRxInternalOperatorsOperatorDistinct_withRxSubscriber_withRxSubscriber_(RxInternalOperatorsOperatorDistinct *outer$, RxSubscriber *capture$0, RxSubscriber *subscriber) {
  J2OBJC_CREATE_IMPL(RxInternalOperatorsOperatorDistinct_1, initWithRxInternalOperatorsOperatorDistinct_withRxSubscriber_withRxSubscriber_, outer$, capture$0, subscriber)
}
